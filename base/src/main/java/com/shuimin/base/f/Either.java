...
public class Either<A, B> {
	...
	public static <A, B, C> _3<A, B, C> _3a(A a) {
		return new Either._3<A, B, C>(S._some(a), S.<B> _none(), S.<C> _none());
	}

	public static <A, B, C> _3<A, B, C> _3b(B b) {
		return new Either._3<A, B, C>(S.<A> _none(), S._some(b), S.<C> _none());
	}

	public static <A, B, C> _3<A, B, C> _3c(C c) {
		return new Either._3<A, B, C>(S.<A> _none(), S.<B> _none(),
				S.<C> _some(c));
	}

	public static <A, B, C, D> _4<A, B, C, D> _4a(A a) {
		return new Either._4<A, B, C, D>(S._some(a), S.<B> _none(),
				S.<C> _none(), S.<D> _none());
	}

	public static <A, B, C, D> _4<A, B, C, D> _4b(B b) {
		return new Either._4<A, B, C, D>(S.<A> _none(), S._some(b),
				S.<C> _none(), S.<D> _none());
	}

	public static <A, B, C, D> _4<A, B, C, D> _4c(C c) {
		return new Either._4<A, B, C, D>(S.<A> _none(), S.<B> _none(),
	...
	public static <A, B, C, D, E> _5<A, B, C, D, E> _5a(A a) {
		return new Either._5<A, B, C, D, E>(S._some(a), S.<B> _none(),
				S.<C> _none(), S.<D> _none(), S.<E> _none());
	}

	public static <A, B, C, D, E> _5<A, B, C, D, E> _5b(B b) {
		return new Either._5<A, B, C, D, E>(S.<A> _none(), S._some(b),
				S.<C> _none(), S.<D> _none(), S.<E> _none());
	}

	public static <A, B, C, D, E> _5<A, B, C, D, E> _5c(C c) {
		return new Either._5<A, B, C, D, E>(S.<A> _none(), S.<B> _none(),
